...
**Last updated**: 2026-03-12 | **Totals**: 26 verified, 1 qualified, 8 disproved, 13 unverified/resolved, 16 new from upstream
...
| UP10 | ~119 compilations per process limit — subsequent compilations silently fail | Orion paper + maderix characterization. Built into ANE hardware state management. | Not relevant for our single-compilation-at-startup approach. Would affect any approach requiring per-step recompilation. Delta compilation (UP7) bypasses this entirely. | LOW |
